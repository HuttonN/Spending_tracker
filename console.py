...
mortage_Feb_23 = Transaction(663.35,Natwest_Bank,Bills,datetime(2023,2,1))
transaction_repository.save(mortage_Feb_23)
mortage_Jan_23 = Transaction(598.86,Natwest_Bank,Bills,datetime(2023,1,3))
transaction_repository.save(mortage_Jan_23)
mortage_Dec_22 = Transaction(598.86,Natwest_Bank,Bills,datetime(2022,12,1))
transaction_repository.save(mortage_Dec_22)
mortage_Nov_22 = Transaction(598.86,Natwest_Bank,Bills,datetime(2022,11,1))
transaction_repository.save(mortage_Nov_22)
mortage_Oct_22 = Transaction(598.86,Natwest_Bank,Bills,datetime(2022,10,3))
transaction_repository.save(mortage_Oct_22)
mortage_Sep_22 = Transaction(598.86,Natwest_Bank,Bills,datetime(2022,9,1))
transaction_repository.save(mortage_Sep_22)
mortage_Aug_22 = Transaction(598.86,Natwest_Bank,Bills,datetime(2022,8,1))
transaction_repository.save(mortage_Aug_22)
